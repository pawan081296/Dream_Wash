...
?>
        ...
        while ($row = mysqli_fetch_array($query))
        {
            ...
            echo "<td><form action='delete_appointment.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Cancel ' class='button1'/></form></td>";
